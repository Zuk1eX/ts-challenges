...
type TestEqual = IsEqual<false, boolean>
...
type Test = Includes<[true, 2, 3, 5, 6, 7], boolean>
type Test2 = Includes<['Kars', 'Esidisi', 'Wamuu', 'Santana'], 'Kars'>
type Test3 = Includes<[false, 2, 3, 5, 6, 7], false>
type Test4 = Includes<[1 | 2], 1>
...
type cases = [
  ...
  Expect<Equal<Includes<[1, 2, 3], undefined>, false>>
]
